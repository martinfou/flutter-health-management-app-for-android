...
See `../TEMPLATES/product-backlog-table-template.md` for the complete table template.
...
See `../TEMPLATES/feature-request-template.md` for the complete template.
...
See `../TEMPLATES/bug-fix-template.md` for the complete template.
...
1. Copy the Feature Request Template from `../TEMPLATES/feature-request-template.md`
...
1. Copy the Bug Fix Template from `../TEMPLATES/bug-fix-template.md`
...
1. Copy the Sprint Planning Template from `../TEMPLATES/sprint-planning-template.md`
...
- **Backlog Management Process**: `backlog-management-process.md`
