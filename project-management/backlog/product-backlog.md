...
| [FR-004](../backlog/features/FR-004-food-suggestion-based-on-remaining-macros.md) | Food Suggestion Based on Remaining Macros | 🟠 High | 8 | ✅ | [Sprint 18](../sprints/sprint-18-food-suggestion-based-on-remaining-macros.md) | 2025-01-02 | 2026-01-03 |
...
| [FR-019](../backlog/features/FR-019-open-food-facts-integration.md) | Open Food Facts Integration with Autocomplete and Barcode Scanning | 🟠 High | 13 | ⭕ | [Sprint 26](../sprints/sprint-26-open-food-facts-integration.md) | 2025-01-27 | 2026-01-17 |
...
- 📋 **Planned**: Sprint planned but not yet started
...
- FR-010: LLM Integration complete (Ollama, OpenAI, Anthropic, DeepSeek)
...
**Completed Sprint 23 Tasks:**
- ✅ Backend API deployed to DreamHost
- ✅ Health metrics sync working (fixed schema mismatch with BF-008)
